...
class SeedBase(BaseModel):
  name: str = Field(default = "process_coffee", description = "Name of the flowchart")
  descript:  str                = Field(default = "Process to prepare and drink coffee", description = "Description of the flowchart")
  startNode: Optional[str]      = Field(default = "n1",description = "Where the flowchart begins")
  nodes: list[NodesVariant] = Field(
    default_factory = lambda: NODE,
    description = "List of nodes")
  edges: list[EdgesVariant] = Field(
    default_factory = lambda: EDGE,
