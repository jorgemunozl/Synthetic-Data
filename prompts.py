...
"""
promptHuman = """Generate a simple but realistic flowchart using the follow structure {seed_value}, about run"""
...
def promptImage(flowChartInfo):
    ...
    For each object in edges:
      ...
      If "condition" isn’t empty, place that text next to the arrow (e.g. “YES” or “NO”).
    Extra styling notes:
